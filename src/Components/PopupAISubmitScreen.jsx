...
function PopupAISubmitScreen({cardContent, submitPromt, cancelPopup}){
  ...
  function buildPrompt(cardContent, lengthInput, toneInput){
    const contentStart = "Pretend you are a wedding officiant and you are writing a wedding ceremony for a couple.  Please take the following exert and do the following to it: ";
